...
clf = factory.BookMethod(dataloader, TMVA.Types.kBDT, "BDT",
...
#model = conifer.model(clf, conifer.converters.tmva, conifer.backends.vivadohls, cfg)
#model.compile()
